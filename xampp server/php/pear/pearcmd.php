...
if ('C:\Users\Raya\Desktop\xampp server\php\pear ' != '@'.'include_path'.'@ ') {
    ini_set('include_path', trim('C:\Users\Raya\Desktop\xampp server\php\pear '). PATH_SEPARATOR .  get_include_path());
    $raw = false;
} else {
